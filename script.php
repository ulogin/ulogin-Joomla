...
//				              "`published`='1'," .
				              ...
				              "`title`=" . $db->quote(str_replace('uLogin - ','',JText::_($name))) .
	    ...
	    $groupData = array(
			'title' => 'uLogin',
		    'parent_id' => JComponentHelper::getParams('com_users')->get('new_usertype'),
		    'id' => 0
	    );
        ...
        <table class="adminlist table table-striped">
            ...
            <tbody>
                ...
                <tr class="row<?php echo(++$rows % 2); ?>">
                    ...
                    <td><strong><?php echo ($module['result'])?JText::_('ULOGIN_INSTALLED'):JText::_('ULOGIN_NOT_INSTALLED'); ?></strong></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
                ...
                <tr class="row<?php echo(++$rows % 2); ?>">
                    ...
                    <td><strong><?php echo ($plugin['result'])?JText::_('ULOGIN_INSTALLED'):JText::_('ULOGIN_NOT_INSTALLED'); ?></strong></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
        ...
        <table class="adminlist table table-striped">
            ...
            <tbody>
                ...
                <tr class="row<?php echo(++$rows % 2); ?>">
                    <td class="key"><?php echo $module['name']; ?></td>
                    <td class="key"><?php echo ucfirst($module['client']); ?></td>
                    <td><strong><?php echo ($module['result'])?JText::_('ULOGIN_REMOVED'):JText::_('ULOGIN_NOT_REMOVED'); ?></strong></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
                ...
                <tr class="row<?php echo(++$rows % 2); ?>">
                    <td class="key"><?php echo ucfirst($plugin['name']); ?></td>
                    <td class="key"><?php echo ucfirst($plugin['group']); ?></td>
                    <td><strong><?php echo ($plugin['result'])?JText::_('ULOGIN_REMOVED'):JText::_('ULOGIN_NOT_REMOVED'); ?></strong></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
